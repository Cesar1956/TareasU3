function validaFechaMenor(campo){
    ...
    var newContent = document.createTextNode("Aries");
    f=1;
    n="#F33131";
    }
    else if ((nDia>=20) && (nMes==4) || (nDia <=20) && (nMes==5)){
    var newContent = document.createTextNode("Tauro");
    f=2;
    n="#F38F31";
    }
    else if ((nDia>=20) && (nMes==5) || (nDia <=20) && (nMes==6)){
    var newContent = document.createTextNode("Geminis");
    f=3;
    n="#F3C731";
    }
    else if ((nDia>=20) && (nMes==6) || (nDia <=22) && (nMes==7)){
    var newContent = document.createTextNode("Cancer");
    f=4;
    n= "#B7EE2D";
    }
    ...
    var newContent = document.createTextNode("Escorpio");
    f=8;
    n="#3CCBCB";
    }
    ...
    imagen1.src = 'media/'+f+'.jpg';
    newDiv.appendChild(imagen1);
    newDiv.style= "text-align:center; font-family:georgia; font-size: 170%; width: 600px ;height:335px; margin:auto";
}